...
> **[Lanterna](https://github.com/mabe02/lanterna) ⭐ 2,621 | 🐛 96 | 🌐 Java | 📅 2026-07-07** <kbd>★ 2.6k</kbd> <kbd>LGPL-3.0</kbd> 🟢<br>Easy console text-GUI library, similar to curses.
...
> **[Delta Coverage](https://github.com/gw-kit/delta-coverage-plugin) ⭐ 41 | 🐛 11 | 🌐 Kotlin | 📅 2026-09-25** <kbd>★ 41</kbd> <kbd>MIT</kbd> 🟢<br>Computes code coverage of new and modified code based on a provided diff, supporting JaCoCo and IntelliJ coverage engines.

> **[JaCoCo](https://github.com/jacoco/jacoco) ⭐ 4,605 | 🐛 253 | 🌐 Java | 📅 2026-09-25** <kbd>★ 4.6k</kbd> 🟢<br>Framework that enables collection of code coverage metrics, using both offline and runtime bytecode instrumentation.
...
> **[JavaCV](https://github.com/bytedeco/javacv) ⭐ 8,345 | 🐛 465 | 🌐 Java | 📅 2026-08-12** <kbd>★ 8.3k</kbd> 🟢<br>Java interface to OpenCV, FFmpeg, and much more.
...
> **[Siddhi](https://github.com/siddhi-io/siddhi) ⭐ 1,593 | 🐛 126 | 🌐 Java | 📅 2026-05-05** <kbd>★ 1.6k</kbd> <kbd>Apache-2.0</kbd> 🟠<br>Cloud native streaming and complex event processing engine.
...
> **[AspectJ](https://github.com/eclipse-aspectj/aspectj) ⭐ 394 | 🐛 80 | 🌐 Java | 📅 2026-09-25** <kbd>★ 394</kbd> 🟠<br>Seamless aspect-oriented programming extension.
...
> **[Apache Geode](https://github.com/apache/geode) ⭐ 2,386 | 🐛 17 | 🌐 Java | 📅 2026-09-25** <kbd>★ 2.4k</kbd> <kbd>Apache-2.0</kbd> 🟢<br>In-memory data management system that provides reliable asynchronous event notifications and guaranteed message delivery.
...
> **[FF4J](https://github.com/ff4j/ff4j) ⭐ 1,453 | 🐛 27 | 🌐 Java | 📅 2026-09-18** <kbd>★ 1.5k</kbd> <kbd>Apache-2.0</kbd> 🟢<br>Feature Flags for Java.

> **[OpenFeature Java SDK](https://github.com/open-feature/java-sdk) ⭐ 128 | 🐛 26 | 🌐 Java | 📅 2026-09-25** <kbd>★ 128</kbd> <kbd>Apache-2.0</kbd> 🟢<br>Vendor-neutral API for evaluating feature flags in Java applications.
...
> **[Philadelphia](https://github.com/paritytrading/philadelphia) ⭐ 346 | 🐛 2 | 🌐 Java | 📅 2026-09-25** <kbd>★ 346</kbd> <kbd>Apache-2.0</kbd> 🟢<br>Low-latency financial information exchange.
...
> **[FXGL](https://github.com/AlmasB/FXGL) ⭐ 4,861 | 🐛 160 | 🌐 Kotlin | 📅 2026-09-25** <kbd>★ 4.9k</kbd> <kbd>MIT</kbd> 🟢<br>JavaFX Game Development Framework.
...
> **[Spatial4j](https://github.com/locationtech/spatial4j) ⭐ 961 | 🐛 77 | 🌐 Java | 📅 2026-08-17** <kbd>★ 961</kbd> 🟢<br>General-purpose spatial/geospatial library.
...
> **[scrimage](https://github.com/sksamuel/scrimage) ⭐ 1,186 | 🐛 28 | 🌐 Java | 📅 2026-09-19** <kbd>★ 1.2k</kbd> <kbd>Apache-2.0</kbd> 🟢<br>Immutable, functional, and performant JVM library for manipulation of images.
...
> **[JsonPath](https://github.com/json-path/JsonPath) ⭐ 9,451 | 🐛 442 | 🌐 Java | 📅 2026-02-22** <kbd>★ 9.5k</kbd> <kbd>Apache-2.0</kbd> 🟠<br>Extract data from JSON using XPATH-like syntax.
...
> **[Moshi](https://github.com/square/moshi) ⭐ 10,164 | 🐛 113 | 🌐 Kotlin | 📅 2026-09-25** <kbd>★ 10.2k</kbd> <kbd>Apache-2.0</kbd> 🟢<br>Modern JSON library, less opinionated and uses built-in types like List and Map.
...
> **[NATS client](https://github.com/nats-io/nats.java) ⭐ 678 | 🐛 8 | 🌐 Java | 📅 2026-09-25** <kbd>★ 679</kbd> <kbd>Apache-2.0</kbd> 🟢<br>NATS client.
...
> **[Undertow](https://github.com/undertow-io/undertow) ⭐ 3,760 | 🐛 45 | 🌐 Java | 📅 2026-09-24** <kbd>★ 3.8k</kbd> <kbd>Apache-2.0</kbd> 🟢<br>Web server providing both blocking and non-blocking APIs based on NIO. Used as a network layer in WildFly.
...
> **[DBCP](https://github.com/apache/commons-dbcp) ⭐ 370 | 🐛 6 | 🌐 Java | 📅 2026-09-24** <kbd>★ 369</kbd> <kbd>Apache-2.0</kbd> 🟢<br>Database connection pooling services.
...
> **[SCXML](https://github.com/apache/commons-scxml) ⭐ 68 | 🐛 8 | 🌐 Java | 📅 2026-09-24** <kbd>★ 68</kbd> <kbd>Apache-2.0</kbd> 🟢<br>Implementation of the State Chart XML specification aimed at creating and maintaining a Java SCXML engine.
...
> **[Akka](https://github.com/akka/akka) ⭐ 13,280 | 🐛 905 | 🌐 Scala | 📅 2026-09-24** <kbd>★ 13.3k</kbd> 🟢<br>Toolkit and runtime for building concurrent, distributed, fault-tolerant and event-driven applications.
...
> **[Restlet Framework](https://github.com/restlet/restlet-framework-java) ⭐ 667 | 🐛 539 | 🌐 Java | 📅 2026-09-24** <kbd>★ 667</kbd> 🟢<br>Pioneering framework with powerful routing and filtering capabilities, and a unified client and server API.
...
> **[BioJava](https://github.com/biojava/biojava) ⭐ 633 | 🐛 68 | 🌐 Java | 📅 2026-09-19** <kbd>★ 632</kbd> <kbd>LGPL-2.1</kbd> 🟢<br>Facilitates processing biological data by providing algorithms, file format parsers, sequencing and 3D visualization commonly used in bioinformatics.
...
> **[OpenAM](https://github.com/OpenIdentityPlatform/OpenAM) ⭐ 896 | 🐛 17 | 🌐 Java | 📅 2026-09-25** <kbd>★ 895</kbd> 🟢<br>Access management solution that includes authentication, SSO, authorization, federation, entitlements and web services security.
...
> **[ScribeJava](https://github.com/scribejava/scribejava) ⭐ 5,453 | 🐛 76 | 🌐 Java | 📅 2026-05-18** <kbd>★ 5.5k</kbd> <kbd>MIT</kbd> 🟠<br>OAuth client library supporting OAuth 1.0a, OAuth 2.0 and numerous providers.
...
> **[Jxls](https://github.com/jxlsteam/jxls) ⭐ 530 | 🐛 18 | 🌐 Java | 📅 2026-09-09** <kbd>★ 531</kbd> <kbd>Apache-2.0</kbd> 🟢<br>Generates Excel reports from spreadsheet templates.
...
> **[jstachio](https://github.com/jstachio/jstachio) ⭐ 333 | 🐛 38 | 🌐 Java | 📅 2025-04-15** <kbd>★ 332</kbd> <kbd>BSD-3-Clause</kbd> 🔴<br>Typesafe Mustache templating engine.

> **[jte](https://github.com/casid/jte) ⭐ 1,141 | 🐛 53 | 🌐 Java | 📅 2026-09-26** <kbd>★ 1.1k</kbd> <kbd>Apache-2.0</kbd> 🟢<br>Compiles to classes, and uses an easy syntax, several features to make development easier and provides fast execution and a small footprint.

> **[Pebble](https://github.com/PebbleTemplates/pebble) ⭐ 1,196 | 🐛 27 | 🌐 Java | 📅 2026-09-25** <kbd>★ 1.2k</kbd> <kbd>BSD-3-Clause</kbd> 🟢<br>Inspired by Twig and separates itself with its inheritance feature and its easy-to-read syntax. It ships with built-in autoescaping for security and it includes integrated support for internationalization.
...
> **[Randomized Testing](https://github.com/randomizedtesting/randomizedtesting) ⭐ 185 | 🐛 19 | 🌐 Java | 📅 2026-09-21** <kbd>★ 184</kbd> <kbd>Apache-2.0</kbd> 🟢<br>JUnit test runner and plugins for running JUnit tests with pseudo-randomness.
...
> **[Java Developer Roadmap](https://github.com/s4kibs4mi/java-developer-roadmap) ⭐ 4,545 | 🐛 0 | 🌐 Java | 📅 2026-03-15**
